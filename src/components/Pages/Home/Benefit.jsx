...
function Benefit() {
  const benefits = [
    ...
    },
    {
      ...
      subLabel:
        "Learn from industry experts who have hands-on experience in designs",
    },
    {
      num: "03",
  ...
  return (
    <div className=" container w-[100%] md:w-[90%] lg:w-[80%] mx-auto mt-[50px]">
...
function BenefitCard({ benefitCard }) {
  ...
  return (
    <div>
      <div
        className="bg-white rounded-[12px] py-[30px] px-[25px] benefit-card"
        data-aos="zoom-in"
      ...
      >
        ...
        <div className="flex justify-end">
          <div className="border border-[#F1F1F3] bg-[#FCFCFD] rounded-[8px] p-[15px] w-[25%] h-[25%] flex justify-center items-center">
            <FontAwesomeIcon
              icon={faArrowRight}
              className="rote text-[#FF9500]"
            />
          </div>
        </div>
      </div>
