...
function LoginSec({ title, des, terms, bridge, or, log }) {
  ...
  return (
    <>
      <div
        className="bg-white rounded-[8px] p-[10px] md:p-[40px]"
        data-aos="zoom-in"
      ...
      >
        <form id="form" onSubmit={handleSubmit}>
          <div>
            <h1 className="text-[38px] font-[600] text-[#262626] text-center">
              {title}
            </h1>
            <p className="text-[#4C4C4D] text-[14px] font-[400] text-center mb-9">
              {des}
            </p>
            <div className="mb-4">
              <Input
                ...
                error={errors.email}
              />
              <span className="text-[12px] text-[red] font-[500]">
                {errors.email}
              </span>
            </div>
            <div>
            ...
            <p className="text-end text-[#4C4C4D] text-[15px] font-[500] py-4">
              Forgot Password?
            </p>
            <div className="flex items-center gap-3 py-4">
              <input type="checkbox" className="checkbox" />
              <span className="text-[15px] font-[500] text-[#59595A]">
                {terms}
              </span>
            </div>
            <Button
