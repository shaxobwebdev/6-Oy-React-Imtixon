  ...
  const cards = [
    {
      ...
      courseDurationStatus: ["4 Weeks", "Beginnner"],
    ...
    },
    {
      ...
      courseDurationStatus: ["6 Weeks", "Intermediate"],
    ...
    },
    {
      ...
      courseDurationStatus: ["8 Weeks", "Intermediate"],
    ...
    },
    {
      ...
      courseDurationStatus: ["10 Weeks", "Beginnner"],
    ...
    },
    {
      ...
      courseDurationStatus: ["10 Weeks", "Intermediate"],
  ...
  return (
    <>
      ...
      <div className={`gap-[50px] grid grid-cols-1`}>
        {cards.map((card) => {
          return <CourseCard key={card.courseTrack} card={card} />;
        })}
      </div>
