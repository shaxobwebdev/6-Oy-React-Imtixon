...
function AboutSec({ secTitle, secPara, cards }) {
  return (
    <>
      <div className=" container w-[100%] md:w-[90%] lg:w-[80%] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] pt-[70px] pb-[70px]">
          {cards.map((card) => {
            return (
              <div
                className="bg-white rounded-[12px] md:p-[40px] p-[20px] benefit-card"
                key={card.cardTitle}
                data-aos="zoom-in"
              ...
              >
                <div>
                  ...
                  <h4 className="text-[20px] text-[#262626] font-[600] mb-2">
                    {card.cardTitle}
                  </h4>
                  <p className="text-[#59595A] font-[400] text-[15px]">
