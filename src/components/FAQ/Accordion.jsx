...
function Accordion({ qest, ans }) {
  ...
  return (
    <div className="border border-[#F1F1F3] rounded-[12px] pt-3 px-3 md:pt-5 md:px-5 mb-[15px] md:mb-[30px]">
      ...
      <div
        className={`pt-5 grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm ${
          accordionOpen
      ...
      >
        <div className="overflow-hidden">
          <hr />
          <p className="text-[15px] text-[#4C4C4D] font-[400] mt-[40px] overflow-hidden pb-3 md:pb-5">
            {ans}
          </p>
        </div>
      </div>
