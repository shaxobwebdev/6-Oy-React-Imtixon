...
function FAQ({ title, brTitle, subTitle, step }) {
  const accordions = [
    {
  ...
  return (
    <div className=" container w-[100%] md:w-[90%] lg:w-[80%] mx-auto mb-[100px]">
      <div className="bg-[#fff] rounded-[12px] p-[20px] lg:p-[50px]">
        <div className="flex justify-between gap-[30px] md:flex-row flex-col">
          <div
            className="md:w-[38%]"
            data-aos="fade-right"
          ...
          >
            <h2 className="text-[28px] md:text-[38px] font-[600] text-[#262626] leading-normal">
              {title}
            </h2>
            <h2 className="text-[28px] md:text-[38px] font-[600] text-[#262626] leading-[35px]">
              {brTitle}
            </h2>
            <p className="mt-[20px] text-[14px] text-[#333] font-[400]">
              {subTitle}
            </p>
          ...
          <div
            className="border border-[#F1F1F3] rounded-[12px] px-[15px] pt-[15px] md:px-[30px] md:pt-[30px] md:w-[62%]"
            data-aos="zoom-in"
            data-aos-easing="ease-in-out"
            data-aos-once="true"
            data-aos-duration="1000"
